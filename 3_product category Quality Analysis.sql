...
create table total_revenue_per_year as to_revenue
select 
...
-- 2. Calculate total canceled orders per year
...
--3. Calculate highest total revenues per product category per year

create table top_product_category_by_revenue_per_year as top_product
select 
	year, 
...
--4. Calculate highest canceled order per product category per year
...
-- 5.Create a new table which contain all the informations above
